...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | INITIAL_KW | FINAL_STEP_KW | ALIASPARAM_KW | PARAMSET_KW | ENDPARAMSET_KW | DEFPARAM_KW => true,
            _ => false,
        }
    }
