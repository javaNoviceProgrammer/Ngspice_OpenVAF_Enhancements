...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ANALOG_KW | BEGIN_KW | BRANCH_KW | CASE_KW | CASEX_KW | CASEZ_KW | DEFAULT_KW | DISABLE_KW
            | DISCIPLINE_KW | ELSE_KW | END_KW | ENDCASE_KW | ENDDISCIPLINE_KW | ENDFUNCTION_KW
            | ENDGENERATE_KW | ENDMODULE_KW | ENDNATURE_KW | EXCLUDE_KW | FOR_KW | FROM_KW
            | FUNCTION_KW | GENERATE_KW | GENVAR_KW | IF_KW | INF_KW | INOUT_KW | INPUT_KW
            | INTEGER_KW | MODULE_KW | NATURE_KW | OUTPUT_KW | PARAMETER_KW | LOCALPARAM_KW
            | REAL_KW | STRING_KW | WHILE_KW | REPEAT_KW | DO_KW | ROOT_KW | INITIAL_STEP_KW
            | INITIAL_KW | FINAL_STEP_KW | ALIASPARAM_KW | PARAMSET_KW | ENDPARAMSET_KW | DEFPARAM_KW | OR_KW => true,
            _ => false,
        }
    }
