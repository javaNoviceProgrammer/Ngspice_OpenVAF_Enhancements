...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | ENDPARAMSET_KW | DEFPARAM_KW | OR_KW | ROOT_KW => true,
            _ => false,
        }
    }
