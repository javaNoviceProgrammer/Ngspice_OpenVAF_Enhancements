...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | REAL_KW | STRING_KW | WHILE_KW | REPEAT_KW | ROOT_KW | INITIAL_STEP_KW | INITIAL_KW
            | FINAL_STEP_KW | ALIASPARAM_KW => true,
            _ => false,
        }
    }
