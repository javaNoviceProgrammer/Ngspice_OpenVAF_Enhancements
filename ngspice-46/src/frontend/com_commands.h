...
void com_corners(wordlist *wl);    /* Enhancement-655 */
...
void com_reduce(wordlist *wl);     /* Enhancement-155 */
void com_aging(wordlist *wl);      /* Enhancement-157 */
void com_emir(wordlist *wl);       /* Enhancement-158 */
