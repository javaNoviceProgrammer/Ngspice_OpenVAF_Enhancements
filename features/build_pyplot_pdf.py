#!/usr/bin/env python3
"""Regenerate the PDF edition of the pyplot feature report.

Usage:  python3 features/build_pyplot_pdf.py
Needs pandoc + xelatex. Repo-relative links become GitHub URLs; wide tables are
column-width-balanced so they wrap inside the page.
"""
import datetime
import os
import re
...
HERE = os.path.dirname(os.path.abspath(__file__))          # features/
ROOT = os.path.dirname(HERE)                                # repo root
GITHUB = "https://github.com/javaNoviceProgrammer/Ngspice_OpenVAF_Enhancements"
STEM = "pyplot_feature_report"
