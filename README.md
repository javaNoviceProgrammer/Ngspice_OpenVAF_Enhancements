...
| 418 | fix: three unchecked things — absdelay/last_crossing read 0 unless contributed, .save never validated a device name, meas when invented a time in the first interval | ngspice | [doc](enhancements_doc/Enhancement-418.md) | [saveguard](examples/saveguard_examples/) |
