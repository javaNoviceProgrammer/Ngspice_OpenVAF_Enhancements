...
|---|---|---|
| `va/` | 40 in-scope examples | **compile cleanly** (exit 0) |
| `limitations/` | 19 in-scope examples openvaf-r rejects today | rejected with the exact pinned diagnostic, **without crashing** |
