...
|---|---|---|
| `va/` | 42 in-scope examples | **compile cleanly** (exit 0) |
| `limitations/` | 17 in-scope examples openvaf-r rejects today | rejected with the exact pinned diagnostic, **without crashing** |
