...
| `table_big.va`, `table_iso.va` | [E-705](../../enhancements_doc/Enhancement-705.md): a **100 000-row** data file and a **30 000-isoline** two-input file, both generated by the verify script (`_big_iv.tbl`, `_big_iso.tbl`); the 100 000-row file used to overflow the compiler's stack. |
| `verify_table.py` | Compiles all four, runs them through ngspice, checks interpolation and its derivative across **DC, AC and transient** against references, and the two big files' compile, values and slope. |
...
E-705: 100 000-row data file compiles         13.4 s, rc 0  PASS
E-705: 100 000-row table, five points        max err 5.86e-17 A  PASS
E-705: 100 000-row table, AC g = segment slope err 5.55e-17 S  PASS
E-705: 30 000-isoline 2-D file compiles        9.4 s, rc 0  PASS
E-705: 30 000-isoline table at (12345.5, 0.25) got 12345.750000 (12345.75)  PASS
ALL PASS
```
