#!/usr/bin/env python3
"""Regenerate the PDF edition of the openvaf-r / OSDI nuances doc.
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=openvaf-r / OSDI Nuances and Gotchas",
            "-V", "subtitle=Non-obvious behaviors at the Verilog-A / OSDI to ngspice-netlist boundary",
