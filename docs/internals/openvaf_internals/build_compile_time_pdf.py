#!/usr/bin/env python3
"""Regenerate the single-file PDF edition of the OpenVAF compile-time analysis.
...
STEM = "OpenVAF_compile_time_analysis"
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=OpenVAF-r Compile-Time Analysis",
            "-V", "subtitle=Where compilation time goes, and which levers actually move it",
