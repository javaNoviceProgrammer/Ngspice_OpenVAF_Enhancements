#!/usr/bin/env python3
"""Regenerate the PDF edition of the OpenVAF natures & disciplines reference.
...
STEM = "openvaf_natures_disciplines"
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=OpenVAF-r Built-in Natures and Disciplines",
            "-V", "subtitle=The Accellera standard natures and disciplines shipped in the openvaf-r compiler",
