#!/usr/bin/env python3
"""Regenerate the single-file PDF edition of the OpenVAF robustness-campaign report.
...
STEM = "OpenVAF_robustness_report"
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=OpenVAF-r Robustness Campaign",
            "-V", "subtitle=Adversarial testing, mutation fuzzing, and the crash/hang paths found and fixed",
