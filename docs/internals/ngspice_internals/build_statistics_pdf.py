#!/usr/bin/env python3
"""Regenerate the PDF edition of the ngspice statistics guide.

Usage:  python3 docs/internals/ngspice_internals/build_statistics_pdf.py
Needs pandoc + xelatex (and the figures under ngspice_statistics_figs/, which
make_statistics_figs.py produces). Repo-relative *links* become GitHub URLs;
