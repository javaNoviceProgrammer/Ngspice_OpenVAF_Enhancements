#!/usr/bin/env python3
"""Regenerate the PDF edition of the OSDI device-bypass investigation note.
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=OSDI/Verilog-A Device Bypass — an Investigation",
            "-V", "subtitle=Why element bypass is not shipped for OSDI devices",
