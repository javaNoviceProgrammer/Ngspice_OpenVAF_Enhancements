#!/usr/bin/env python3
"""Regenerate the PDF edition of the temperature / multiplier note.

Usage:  python3 docs/internals/ngspice_internals/build_temperature_pdf.py
Needs pandoc + xelatex, and the figures under ngspice_temperature_figs/ that
make_temperature_figs.py produces. Repo-relative *links* become GitHub URLs; *image*
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=Temperature and the multiplier in ngspice",
            "-V", "subtitle=How m, temp, dtemp and dt reach an OSDI (Verilog-A) device -- routing, conventions, and verification",
