#!/usr/bin/env python3
"""Regenerate the PDF edition of the LRM compliance document.

Usage:  python3 docs/compliance/build_pdf.py
Needs pandoc + xelatex. Repo-relative links become GitHub URLs; the
emoji status marks map to math symbols the text font can render.
"""
import datetime
import os
import re
...
HERE = os.path.dirname(os.path.abspath(__file__))          # docs/compliance
ROOT = os.path.dirname(os.path.dirname(HERE))              # repo root
GITHUB = "https://github.com/javaNoviceProgrammer/Ngspice_OpenVAF_Enhancements"
STEM = "OpenVAF_Verilog-A_LRM_Compliance"
...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([
            ...
            "-V", "title=OpenVAF — Verilog-A LRM Compliance",
            "-V", "subtitle=Clause-by-clause coverage of the Verilog-A language (VAMS LRM 2023, Annex C)",
